...
public class OnScreenTap_scene3 : MonoBehaviour
{
	[Range(0.2f, 5f)]
	...
	void CalculateMidPoint()
	{
		...
		midPos = Vector3.Lerp(movingObject.position, destPos, 0.5f);
		midPos += new Vector3(Random.Range(0.2f, 1f), Random.Range(0.2f, 1f), Random.Range(0.2f, 1f));
		renderingLine.SetPosition(1, midPos);
	}
